...
class SectionController extends Controller
{
    ...
    public function bulkDestroy(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error("Ошибка при массовом удалении секций: "
                . $e->getMessage(), ['ids' => $sectionIds]);
            return back()
    ...
    public function bulkUpdateActivity(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            Section::whereIn('id', $validated['ids'])
                ->update(['activity' => $validated['activity']]);

            DB::commit();

            Log::info('Массово обновлена активность секций', [
            ...
            DB::rollBack();
            Log::error("Ошибка массового обновления активности секций: " . $e->getMessage());
    ...
    public function clone(Request $request, Section $section): RedirectResponse
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error("Ошибка при клонировании секции ID {$section->id}: "
