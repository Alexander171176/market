...
return [
    ...
    'values.array' => 'Список значений должен быть массивом.',
    'values.*.integer' => 'ID значения должен быть числом.',
    'values.*.exists' => 'Указанное значение характеристики не найдено.',
    'values.*.id.required_with' => 'Для каждого элемента списка нужен ID значения.',
    'values.*.id.integer' => 'ID значения должен быть числом.',
    'values.*.id.exists' => 'Указанное значение характеристики не найдено.',
    'values.*.sort.integer' => 'Порядок значения должен быть целым числом.',
    'values.*.sort.min' => 'Порядок значения не может быть отрицательным.',
