export default {
    ...
    addPropertiesGroup: 'Add a feature group',
    addPropertiesValue: 'Add a characteristic value',
    addProperty: 'Add a characteristic',
    addRole: 'Add a Role',
    addRow: 'Add a line',
    ...
    banners: 'Banners',
    baseUnit: 'Unit of base currency',
    bio: 'Biography',
    ...
    createCurrency: 'Create a store currency',
    ...
    createPropertyGroup: 'Create a Feature Group',
    createPropertyValue: 'Create value of the characteristic',
    ...
    currencyRefreshRates: 'Update provider rates',
    currencySpace: 'Space',
    ...
    editCurrency: 'Edit the Currency',
    ...
    editPropertyValue: 'Edit the value of a characteristic',
    ...
    propertiesCount: 'Number of characteristics',
    propertyGroups: 'Groups characteristics',
    propertyValue: 'Values of characteristics',
    propertyValues: 'Values of characteristics',
    provider: 'Provider',
    publishedAt: 'Date of publication',
    quantity: 'Quantity',
    rate: 'Rate',
    rateForOneBase: 'for 1 base currency',
    ratesRefreshed: 'Exchange rates have been updated.',
    ...
    saveRate: 'Maintain the exchange rate',
    saved: 'Saved.',
    ...
    symbol: 'Symbol',
    symbolFirst: 'The currency symbol is displayed before the number',
    systems: 'Systems',
    tags: 'Tags',
    ...
    welcome: 'Welcome',
    validationInvalidData: 'Please check the data for correctness.',
    venue: 'Venue',
    version: 'Version',
    videoCode: 'HTML Code',
