...
<template>
    ...
    <SidebarLink :href="route('admin.products.index')"
    ...
    <SidebarLink :href="route('admin.backup.index')"
                 :active="route().current('backup.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                <!-- Первая шестерёнка -->
    ...
    <SidebarLink :href="route('admin.files.index')"
    ...
    <SidebarLink :href="route('admin.robot.index')"
                 :active="route().current('robot.index')"
                 :expanded="props.expanded">
        <template #default>
            <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                <circle class="fill-current text-blue-600" cx="16" cy="8" r="8"></circle>
