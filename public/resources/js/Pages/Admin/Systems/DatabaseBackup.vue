    ...
    <AdminLayout :title="t('databaseBackup')">
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-12xl mx-auto">
            <div class="p-4 bg-slate-50 dark:bg-slate-700 border border-blue-400 dark:border-blue-200 overflow-hidden shadow-lg shadow-gray-500 dark:shadow-slate-400 bg-opacity-95 dark:bg-opacity-95">
                ...
                <!-- Прогресс -->
                <div v-if="step > 0 || progress > 0" class="mb-6 w-full">
                ...
                <div class="mt-6">
                    ...
                    <ul v-else class="divide-y border rounded">
                        <li v-for="backup in backups" :key="backup.name" class="flex items-center justify-between px-3 py-1 bg-gray-100 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-slate-800">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button
                                    ...
                                    :disabled="isProcessing"
                                    class="w-8 h-8 flex items-center justify-center rounded-sm border border-slate-400 dark:border-slate-200 bg-teal-200 hover:bg-teal-300 dark:bg-teal-700 dark:hover:bg-teal-600 text-teal-600 dark:text-slate-100 transition">
                                ...
                                <button
                                    ...
                                    :disabled="isProcessing"
                                    class="w-8 h-8 flex items-center justify-center rounded-sm border border-slate-400 dark:border-slate-200 bg-red-200 hover:bg-red-300 dark:bg-red-700 dark:hover:bg-red-600 text-red-600 dark:text-slate-100 transition">
